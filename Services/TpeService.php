...
class TpeService
{
    ...
    public function __construct(Container $container)
    {
        ...
        // Config du bundle
        $this->version = $this->container->getParameter('rm_paiement_cmcic.serveur')['VERSION'];

        $configClient = $this->container->getParameter('rm_paiement_cmcic.client');
        ...
        $configUrl = $this->container->getParameter('rm_paiement_cmcic.urls');
        $this->urlPaiement = $configUrl['URL_PAIEMENT'];

        // URL prod ou preprod en fonction de l'environnement (variable retour)
        $configServeur = $this->container->getParameter('rm_paiement_cmcic.serveur');
        ...
        $this->cle = $this->container->getParameter('rm_paiement_cmcic.secret')['CLE'];
